...
export default function CreateScreen({ theme }: CreateScreenProps) {
  return (
    <div className="flex flex-col h-full">
      ...
      >
        ...
        >
          Your journey starts now. Complete experiences, earn XP, and make a difference in your community.
        </motion.p>
      </div>
    </div>
  )
